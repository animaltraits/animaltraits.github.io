This directory contains functions for converting raw observations from
multiple CSV files into a single standardised CSV file.  The main
function for standardising observations is StandardiseObservations in
standardise.R.
...
constants.R        - set of common definitions: file and directory names, known trait names, raw data columns etc.
